...
print("Um símbolo x significa algarismo certo no lugar errado")
...
alg_cent = int(randint(1, 9) * 100)
alg_dez = int(randint(1, 9) * 10)
alg_unid = int(randint(1, 8) * 1)

tupla_senha = (alg_cent, alg_dez, alg_unid)
print(tupla_senha[0], tupla_senha[1], tupla_senha[2])

senha = alg_cent + alg_dez + alg_unid
print(senha)
...
while palpite != senha:
    ...
    primeiro_alg = leiaint() * 100
    segundo_alg = leiaint() * 10
    terceiro_alg = leiaint() * 1
    palpite = primeiro_alg + segundo_alg + terceiro_alg
    ...
    if primeiro_alg == tupla_senha[0]:
        dica_cent = "@"
    elif primeiro_alg == tupla_senha[1] or tupla_senha[2]:
        dica_cent = "o"
    else:
        dica_cent = "x"
    ...
    if segundo_alg == tupla_senha[1]:
        dica_dez = "@"
    elif segundo_alg == tupla_senha[0] or tupla_senha[2]:
        dica_dez = "o"
    else:
        dica_dez = "x"
    ...
    if terceiro_alg == tupla_senha[2]:
        dica_unid = "@"
    elif terceiro_alg == tupla_senha[0] or tupla_senha[1]:
        dica_unid = "o"
    else:
        dica_unid = "x"

    print("Seu palpite é {} ... sua dica é ... {}{}{}".format(palpite, dica_cent, dica_dez, dica_unid))
